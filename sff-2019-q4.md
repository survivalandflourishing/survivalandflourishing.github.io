...
SFF specifically will still continue making all of the grants it makes publicly visible on its homepage ([http://survivalandflourishing.fund/](http://survivalandflourishing.fund/)), but if some of those grants are not endorsed by an S-process round, they will not be listed as an S-process grant.    
